...
class _$InitialImpl implements _Initial {
  const _$InitialImpl({this.index = 0, this.controller});
  ...
  @override
  String toString() {
    return 'BottomNavState(index: $index, controller: $controller)';
  }
...
abstract class _Initial implements BottomNavState {
  const factory _Initial({final int index, final PageController? controller}) =
      _$InitialImpl;
