...
class UpdateStudent implements UseCase<Resource<String>, Student> {
  ...
  Future<Resource<String>> call(Student params) async {
    final StudentModel studentModel = StudentModel(
        ...
        inBin: params.inBin);
    var resp = await _studentRepo.updateStudent(studentModel);
    try {
      await _addActivity(AddActivityParams(
          userId: studentModel.userId,
          activity: "Updated ${studentModel.name} details"));
    } catch (_) {}
    return resp;
  }
}
